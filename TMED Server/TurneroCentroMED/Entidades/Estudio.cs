    ...
    [Serializable]public class ListaEstudios : List<Estudio>
    {
        ...
        private DateTime GetAppointment(Paciente paciente, Estudio estudio)  // This es la cola de estudios del departamento.
        {
            ...
            {   
                ...
                //if (DateTime.Parse("8 00 00") > this[i].Hora_de_turno.AddMinutes(this[i].EstudioDuracion) && 
                    this[i].Hora_de_turno.AddMinutes(this[i].EstudioDuracion) >= paciente.HoraDisponible  &&
                    this[i].Hora_de_turno.AddMinutes(this[i].EstudioDuracion) < DateTime.Parse("6 00 00"))  // Si la hora mas la duracion de el estudio en cuestiones igual a mayor que la que deseamos
